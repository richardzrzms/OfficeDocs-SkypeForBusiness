...
The attendance report for Teams meetings and webinars shows organizers who attended a meeting or webinar, what time each person joined and left, who registered for a Teams webinar, and who sent reactions, raised hands, unmuted and more. As an admin, you control whether meeting organizers can view or download an attendance report (formerly known as an "engagement report"). By default, the ability to download the report is on.
